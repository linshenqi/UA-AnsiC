/** 
 * @file opcua_p_socket.h
 * @brief Mapping between platform and low level api for network/socket related functionality.
 *
 * This file houses the platform layer implementation of the socket/network interface.
 * Low level functions working with the system socket, as well as utility functions related
 * to network are defined here.
 * The higher level functions for the select driven socket and event system are also
 * defined and described in this header file.
 * Some of the functions defined here interact with the timer module.
 *  
